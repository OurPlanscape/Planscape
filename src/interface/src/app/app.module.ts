...
import { ChangePasswordComponent } from './account-dialog/change-password/change-password.component';
import { EditAccountComponent } from './account-dialog/edit-account/edit-account.component';
