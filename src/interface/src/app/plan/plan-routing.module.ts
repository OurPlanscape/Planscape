...
const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@app/plan/climate-foresight/climate-foresight.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        '@app/plan/climate-foresight/climate-foresight-run/climate-foresight-run.component'
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        '@app/plan/climate-foresight/climate-foresight-run/analysis/analysis.component'
