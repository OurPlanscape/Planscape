...
describe('ViewScenarioComponent (polling)', () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        MockProvider(FeatureService, {
          isFeatureEnabled: (_: string) => true,
        }),
      ],
    }).compileComponents();
  });
  ...
  it('does NOT poll for geopackage when the feature flag is OFF', fakeAsync(() => {
    const featureSvc = TestBed.inject(
      FeatureService
    ) as jasmine.SpyObj<FeatureService>;
    featureSvc.isFeatureEnabled = jasmine.createSpy().and.returnValue(false);
