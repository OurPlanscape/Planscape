...
const meta: Meta<TreatmentPrescriptionComponent> = {
  title: 'Components/Treatment Prescription',
  component: TreatmentPrescriptionComponent,
  decorators: [
    applicationConfig({
  ...
  render: ({ ...args }) => ({
    props: args,
    template: `<div ${containerStyle}><div style='width:400px;'><sg-treatment-prescription ${argsToTemplate(args)}></sg-treatment-prescription></div>`,
  }),
};

export default meta;
type Story = StoryObj<TreatmentPrescriptionComponent>;
