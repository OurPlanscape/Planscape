...
class AllConditionStatsTest(RasterConditionRetrievalTestCase):
    ...
    def test_computes_stats(self):
        ...
        bar_raster = RasterConditionRetrievalTestCase._create_raster(
            self, 4, 4, (9, 10, 11, 12, 13, 14, 15, 16, 1, 2, 3, 4, 5, 6, 7, 8)
        )
        ...
        bar_condition = ConditionScores.objects.get(condition_id=bar_id)
        ...
        baz_condition = ConditionScores.objects.get(condition_id=baz_id)
    ...
    def test_raises_error_for_missing_geo(self):
        ...
        self.assertEqual(str(context.exception), "plan is missing geometry")
    ...
    def test_raises_error_for_invalid_geo(self):
        ...
        with self.assertRaises(Exception) as context:
            fetch_or_compute_condition_stats(plan)
        self.assertIn("invalid geo: Self-intersection[", str(context.exception))
    ...
    def test_raises_error_for_missing_raster(self):
        ...
        Condition.objects.create(
            raster_name="foo_normalized", condition_dataset=base_condition, is_raw=False
        )
    ...
    def test_raises_error_for_bad_region(self):
        geo = RasterConditionRetrievalTestCase._create_geo(self, 0, 3, 0, 1)
        plan = Plan.objects.create(geometry=geo, region_name="nonsensical region")
    ...
    def test_computes_no_score_for_nodata_values(self):
        ...
        self.assertDictEqual(stats, {"foo": {"mean": None, "sum": 0.0, "count": 0.0}})
