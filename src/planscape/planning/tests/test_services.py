...
class TestExportToGeopackage(TestCase):
    def setUp(self):
        ...
        data = {
            ...
            "bar": 1,
            "baz": 1.2,
            "almost_zero": -4.02696541109141e-34,
            "datalayer_very_big_int": 1566335381369860000000000000000000000,
            "datalayer_very_big_negative_int": -1566335381369860000000000000000000000,
            "now": str(datetime.now()),
            "today": date.today(),
        }
