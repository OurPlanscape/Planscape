...
POSTPROCESSING_FUNCTIONS <- list(
  ...
  american_indian_alaska_native_concentration = average_ses,
  ...
  asian_concentration = average_ses,
  ...
  black_african_concentration = average_ses,
  ...
  damage_potential_wui = average_ses,
  ...
  hispanic_black_indigenous_concentration = average_ses,
  hispano_latino_concentration = average_ses,
  ...
  low_income_population = average_ses,
  ...
  wetland_diversity = average_ses,
  wildlife_species_richness = average_per_stand,
  wui_damage_potential = average_ses
)
