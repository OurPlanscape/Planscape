...
FORISK_MILLS_PLANSCAPE_ORG_ID = config("FORISK_MILLS_PLANSCAPE_ORG_ID", default=1, cast=int)
...
DEFAULT_ADMIN_PASSWORD = config("DEFAULT_ADMIN_PASSWORD", default=None)
