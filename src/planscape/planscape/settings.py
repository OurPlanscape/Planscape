...
FORISK_MILLS_DATASET_NAME = config("FORISK_MILLS_DATASET_NAME", default=None)
FORISK_MILLS_SUB_KEY = config(
    "FORISK_MILLS_SUB_KEY",
    default=config("FORISK_SUB_KEY", default=None),
)
FORISK_MILLS_USER_KEY = config(
    "FORISK_MILLS_USER_KEY",
    default=config("FORISK_USER_KEY", default=None),
)
FORISK_MILLS_API_URL = config("FORISK_MILLS_API_URL", default=None)
FORISK_MILLS_TIMEOUT = config("FORISK_MILLS_TIMEOUT", default=120, cast=int)
FORISK_MILLS_PLANSCAPE_EMAIL = config("FORISK_MILLS_PLANSCAPE_EMAIL", default=None)
FORISK_MILLS_PLANSCAPE_PASSWORD = config(
    "FORISK_MILLS_PLANSCAPE_PASSWORD",
    default=None,
)
FORISK_MILLS_PLANSCAPE_ORG = config("FORISK_MILLS_PLANSCAPE_ORG", default=1, cast=int)
FORISK_MILLS_PLANSCAPE_ENV = config("FORISK_MILLS_PLANSCAPE_ENV", default="dev")
