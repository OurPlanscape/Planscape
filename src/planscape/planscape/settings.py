...
CATALOG_RESTORE_CRON_MINUTE = config("CATALOG_RESTORE_CRON_MINUTE", "0", cast=str)
CATALOG_RESTORE_CRON_HOUR = config("CATALOG_RESTORE_CRON_HOUR", "3", cast=str)
CATALOG_RESTORE_CRON_DAY_OF_WEEK = config(
    "CATALOG_RESTORE_CRON_DAY_OF_WEEK", "*", cast=str
)
CATALOG_RESTORE_CRON_DAY_OF_MONTH = config(
    "CATALOG_RESTORE_CRON_DAY_OF_MONTH", "*", cast=str
)
CATALOG_RESTORE_CRON_MONTH_OF_YEAR = config(
    "CATALOG_RESTORE_CRON_MONTH_OF_YEAR", "*", cast=str
)
