...
PLANSCAPE_DATABASE_INSTANCE_CONNECTION_NAME = config(
    "PLANSCAPE_DATABASE_INSTANCE_CONNECTION_NAME", default=None
)
if PLANSCAPE_DATABASE_INSTANCE_CONNECTION_NAME:
    PLANSCAPE_DATABASE_HOST = f"/cloudsql/{PLANSCAPE_DATABASE_INSTANCE_CONNECTION_NAME}"
else:
...
PLANSCAPE_DATABASE_PORT = config(
    "PLANSCAPE_DATABASE_PORT", default=config("PLANSCAPE_PORT", default=5432)
)
DATABASES = {
    "default": {
