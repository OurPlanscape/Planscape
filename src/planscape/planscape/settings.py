...
CATALOG_BACKUP_CRON_MINUTE = config("CATALOG_BACKUP_CRON_MINUTE", 0, cast=int)
CATALOG_BACKUP_CRON_HOUR = config("CATALOG_BACKUP_CRON_HOUR", 2, cast=int)
CATALOG_DEV_LOAD_CRON_MINUTE = config("CATALOG_DEV_LOAD_CRON_MINUTE", 0, cast=int)
CATALOG_DEV_LOAD_CRON_HOUR = config("CATALOG_DEV_LOAD_CRON_HOUR", 3, cast=int)
CATALOG_DEV_LOAD_WEEKLY = config("CATALOG_DEV_LOAD_WEEKLY", False, cast=bool)
CATALOG_DEV_LOAD_WEEKLY_DAY = config("CATALOG_DEV_LOAD_WEEKLY_DAY", "mon")
CATALOG_STAGING_LOAD_ENABLED = config(
    "CATALOG_STAGING_LOAD_ENABLED", False, cast=bool
)
CATALOG_STAGING_LOAD_INTERVAL_DAYS = config(
    "CATALOG_STAGING_LOAD_INTERVAL_DAYS", 7, cast=int
)
