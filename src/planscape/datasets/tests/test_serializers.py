...
class DataLayerSerializerTest(TestCase):
    def test_data_layer_serializer(self):
        ...
        self.assertEqual(data["organization"]["id"], data_layer.organization.id)
        self.assertEqual(data["organization"]["name"], data_layer.organization.name)
        self.assertEqual(data["dataset"]["id"], data_layer.dataset.id)
        self.assertEqual(data["dataset"]["name"], data_layer.dataset.name)
