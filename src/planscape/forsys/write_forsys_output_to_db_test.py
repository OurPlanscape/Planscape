...
from forsys.forsys_request_params import ForsysGenerationRequestParams, DbRequestParams
...
class CreatePlanAndScenarioTest(TestCase):
    ...
    def test_creates_plan_and_scenario(self):
        ...
        weighted_priorities = {
            ...
            for wp in ScenarioWeightedPriority.objects.filter(scenario_id=scenario.pk)
        }
...
class SaveGenerationOutputToDbTest(TestCase):
    ...
    def test_saves_generation_output_to_db(self):
        ...
        p1 = RankedProjectArea.objects.get(scenario_id=self.scenario.pk, rank=1)
        ...
        p2 = RankedProjectArea.objects.get(scenario_id=self.scenario.pk, rank=2)
