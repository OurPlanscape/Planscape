...
class Project(models.Model):
    ...
    priorities = models.ManyToManyField(
        "conditions.Condition", through="ConfigPriority"
    )  # type: ignore
...
class ConfigPriority(models.Model):
    ...
    condition = models.ForeignKey("conditions.Condition", on_delete=models.CASCADE)
...
class Scenario(models.Model):
    ...
    plan = models.ForeignKey(Plan, on_delete=models.CASCADE, null=False)  # type: ignore
...
class ScenarioWeightedPriority(models.Model):
    ...
    scenario = models.ForeignKey(Scenario, on_delete=models.CASCADE)  # type: ignore
