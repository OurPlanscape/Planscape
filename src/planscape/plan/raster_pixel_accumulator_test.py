...
class RasterPixelAccumulatorTest(TestCase):
    def test_inits_geo_in_specified_srs(self) -> None:
        ...
        geo.transform(CoordTransform(
            accumulator.RASTER_SR, SpatialReference(4269)))
    ...
    def test_updates_initialized_geo(self) -> None:
        polygon1 = Polygon(((-121, 39),
                           (-121, 40),
                           (-120, 40),
                           (-120, 39),
                           (-121, 39)))
        polygon1.srid = 4269
        polygon2 = Polygon(((-120, 39),
                            (-120, 40),
                            (-119, 40),
                            (-119, 39),
                            (-120, 39)))
    ...
    def _set_up_accumulator_with_coordinates(
            self, coords: tuple) -> RasterPixelAccumulator:
        throwaway_polygon = Polygon(((-121, 39),
                                     (-121, 40),
                                     (-120, 40),
                                     (-121, 39)))
