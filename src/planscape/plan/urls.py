...
from plan.views import (create_plan, create_project, create_project_area,
                        ...
                        list_scenarios_for_plan, queue_forsys_lambda_prototype,
                        treatment_goals_config, unfavorite_scenario, 
                        update_project, update_scenario)
...
urlpatterns = [
    ...
    path('create_project_areas_for_project/', create_project_areas_for_project,
    ...
    path('queue_forsys_lambda_prototype/', queue_forsys_lambda_prototype, name='queue_forsys_lambda_prototype'),
]
