...
class CalMAPPER(APIView):
    def get(self, request):
        ...
        url_final = (
            "https://services1.arcgis.com/jUJYIo9tSA7EHvfZ/ArcGIS/rest/services/CMDash_v3_view/FeatureServer/2/query?"
...
class MillionAcres_ITS(APIView):
    def get(self, request):
        ...
        url_final = (
            "https://gsal.sig-gis.com/server/rest/services/Hosted/Million_Acres_Flat_File_2020_2021/FeatureServer/736/query?"
            + urllib.parse.urlencode(params)
        )
        response = requests.get(url=url_final)
        return Response(response.text)
